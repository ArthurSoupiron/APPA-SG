...
const CONSTELLATION_AURORA_COLORS = ["#2d9a52", "#3fad5d", "#5ecf8a", "#1a6b38"] as const;

function Wordmark({ wordmarkClass }: { wordmarkClass: string }) {
  return (
    <div className="min-w-0" role="presentation">
      <AuroraText
        className={cn("font-heading font-semibold tracking-tight text-balance", wordmarkClass)}
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <div className={s.tagline}>by JEECE</div>
      </div>
    </div>
  );
}
