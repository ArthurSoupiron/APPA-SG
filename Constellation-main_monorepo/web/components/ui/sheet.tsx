...
const sheetContentSizeClasses = {
  ...
  wide:
    "data-[side=left]:!w-[50vw] data-[side=right]:!w-[50vw] data-[side=left]:!max-w-[50vw] data-[side=right]:!max-w-[50vw]",
} as const;
...
function SheetContent({
  ...
  /** `wide` : ~50 % de la largeur viewport (panneaux détail type ticket SI). */
  size?: keyof typeof sheetContentSizeClasses;
