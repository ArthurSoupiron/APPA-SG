...
import { getLatestYouTubeCache, syncYouTube } from "../../lib/marketing/youtube-sync";
import type { AppVariables } from "../../types/app";

export function registerMarketingYouTubeRoutes(app: HonoType<{ Variables: AppVariables }>) {
  ...
  r.get("/youtube/status", async (c) => {
    ...
    const latest = env.youtubeChannelId ? await getLatestYouTubeCache(env.youtubeChannelId) : null;
