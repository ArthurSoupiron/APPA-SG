...
| Rôle | Permission | Routes UI |
|------|------------|-----------|
| Utilisateur authentifié | (aucune permission dédiée) | `/account` (mes tickets), `POST /api/app/si/tickets` |
| Agent support | `si.ticket.manage` | `/si` (panel), actions statut / assignation |
