...
import type { PretextTag } from "@/components/typography/pretext-block";
...
export function SiTicketsView(props: {
  ...
  /** Intégré dans une page parente (sans wrapper page dupliqué) */
  embedded?: boolean;
  titleAs?: PretextTag;
  titleMetric?: PretextMetric;
}) {
    ...
    <>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="space-y-1">
          <PretextBlock
            as={props.titleAs ?? "h1"}
            metric={props.titleMetric ?? PRETEXT.h1Page}
            text={props.title}
          />
          <PretextBlock
            as="p"
